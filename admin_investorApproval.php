...
<div class="navbar" style="margin-top:20px;">
            ...
            <ul>
                ...
                <li><a href="admin_professorEditDelete.php">Professor</a></li>
...
<!-- 
     ...
     <label style="font-size:40px; "> <?=$row['investorname']?></label>
        <div style="float:right;margin-right:20px; margin-top:-40px;">
        <a style=" margin-left:1200px;color:black; font-size:20px;" href="admin_investorApprovalAccept.php?investorid=<?php echo $row['investorid']?>"><span style="font-size:40px; color:black;" class="material-icons">
check
</span></a>
<a style="font-size:20px;margin-left:20px; color:black; " href="admin_investorApprovalReject.php?investorid=<?php echo $row['investorid']?>"><span style="font-size:40px; color:black;" class="material-icons">
close
</span></a>
        </div>
        ...
        <!-- <label style="font-size:20px; "><?=$row['approve']?></label> -->
